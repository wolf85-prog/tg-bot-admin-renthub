...
import { getUpdateManagers, getUpdateAvatars } from './../http/adminAPI';
...
const AppHeader = (props) => {
  ...
  const { workerUpdate, setManagerUpdate, avatarUpdate, setAvatarUpdate, showUpdate, showUpdate2, setShowUpdate, setShowUpdate2, 
