                ...
                setTimeout(async()=> { 
                    ...
                    if (blockedWork.dataValues.block !== null && blockedWork.dataValues.block) {
                        ...
                        if (text !== '') {
                            ...
                            url_send_photo = `https://api.telegram.org/bot${token}/sendPhoto?chat_id=${user}&photo=${image}&reply_markup=${keyboard}`
                            console.log("url_send_photo2: ", url_send_photo)
                    ...
                    if (blockedWork.dataValues.block !== null && blockedWork.dataValues.block) {
                        ...
                        if (textButton === '') {
                            ...
                            keyboard = JSON.stringify({
                                inline_keyboard: [
                                    [
                                        {"text": textButton, callback_data:'/report_cep ' + valueProject}, //web_app: {url: target}}, 
                                    ],
                                ]
                            });
                        }
